...
declare class BabelNode {
  ...
  loc: ?BabelNodeSourceLocation;
  range: [number, number]; // NOTE: was added. ESlint specific.
}
...
declare class BabelNodeClassProperty extends BabelNode {
  ...
  optional?: boolean;
  readonly?: boolean;
  variance?: BabelNodeVariance; // NOTE: was added
}
...
declare module '@babel/types' {
  ...
  declare function declareClass(
    ...
    body: BabelNodeObjectTypeAnnotation,
    _implements?: $ReadOnlyArray<BabelNodeClassImplements>,
    mixins?: $ReadOnlyArray<BabelNodeInterfaceExtends>,
  ): BabelNodeDeclareClass;
  ...
  declare type TraversalAncestors = $ReadOnlyArray<{
    node: BabelNode,
    key: string,
    index?: number,
  }>;
